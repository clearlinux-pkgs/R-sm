...
Version  : 2.2.5.7
Release  : 42
URL      : https://cran.r-project.org/src/contrib/sm_2.2-5.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sm_2.2-5.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641125220
